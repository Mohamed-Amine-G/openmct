...
define([
    ...
    plugins.ParkingLog = ParkingLogPlugin.default;
    plugins.ParkingTable = ParkingTablePlugin.default;
    plugins.ParkingMap = ParkingMapPlugin.default;
    plugins.ParkingGenerator = ParkingGeneratorPlugin.default;
