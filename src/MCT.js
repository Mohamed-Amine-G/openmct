...
define([
    ...
    function MCT() {
        ...
        this.install(this.plugins.ParkingLog());
        this.install(this.plugins.ParkingMap());
        this.install(this.plugins.ParkingTable());
        this.install(this.plugins.ParkingGenerator());
    }
